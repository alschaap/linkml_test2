# Contributing to test2

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
test2. These guidelines are not strict rules.
...
The test2 team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the test2 technical leads
...
[issues]: https://github.com/alschaap/test2/issues/
[pulls]: https://github.com/alschaap/test2/pulls/
